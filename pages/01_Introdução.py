...
st.markdown("""Muito bem, então o que é o MIMUF?""")

st.image("content/images/mimuf_inicio.jpg", caption="inicio_mimuf")

st.markdown("""O MIMUF é uma plataforma de extração dos dados que são gerados durante a actividade de uma unidade funcional dos cuidados de saúde primários.
...
st.markdown("""O MIMUF está organizado num sistema de pastas, sendo que estas pastas principais vou-lhes chamar de módulos
